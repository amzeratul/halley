...
private:
	...
	void initBase() override final {
		...
		initialiseFamilyBinding<T, MainFamily>(mainFamily, static_cast<T*>(this), false);
		initialiseFamilyBinding<T, ReplicatorFamily>(replicatorFamily, static_cast<T*>(this), false);
	}
