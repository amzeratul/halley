...
public:
	...
	void serializeNetwork(const Halley::ByteSerializationContext& _context, Halley::Serializer& _serializer) const {
		Halley::ByteSerializationHelper<decltype(position)>::serialize(position, _context, _serializer, componentIndex, "position");
		Halley::ByteSerializationHelper<decltype(scale)>::serialize(scale, _context, _serializer, componentIndex, "scale");
		Halley::ByteSerializationHelper<decltype(rotation)>::serialize(rotation, _context, _serializer, componentIndex, "rotation");
		Halley::ByteSerializationHelper<decltype(height)>::serialize(height, _context, _serializer, componentIndex, "height");
		Halley::ByteSerializationHelper<decltype(fixedHeight)>::serialize(fixedHeight, _context, _serializer, componentIndex, "fixedHeight");
		Halley::ByteSerializationHelper<decltype(subWorld)>::serialize(subWorld, _context, _serializer, componentIndex, "subWorld");
	}

	void deserializeNetwork(const Halley::ByteSerializationContext& _context, Halley::Deserializer& _deserializer) {
		Halley::ByteSerializationHelper<decltype(position)>::deserialize(position, _context, _deserializer, componentIndex, "position");
		Halley::ByteSerializationHelper<decltype(scale)>::deserialize(scale, _context, _deserializer, componentIndex, "scale");
		Halley::ByteSerializationHelper<decltype(rotation)>::deserialize(rotation, _context, _deserializer, componentIndex, "rotation");
		Halley::ByteSerializationHelper<decltype(height)>::deserialize(height, _context, _deserializer, componentIndex, "height");
		Halley::ByteSerializationHelper<decltype(fixedHeight)>::deserialize(fixedHeight, _context, _deserializer, componentIndex, "fixedHeight");
		Halley::ByteSerializationHelper<decltype(subWorld)>::deserialize(subWorld, _context, _deserializer, componentIndex, "subWorld");
	}
