...
namespace Halley
{
	...
	public:
		...
		virtual CodeGenResult generateSystem(SystemSchema system, const HashMap<String, ComponentSchema>& components, const HashMap<String, MessageSchema>& messages, const HashMap<String, SystemMessageSchema>& systemMessages) = 0;
