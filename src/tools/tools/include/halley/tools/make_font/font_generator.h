...
namespace Halley
{
	...
	public:
		...
		FontGeneratorResult generateFont(const Metadata& meta, gsl::span<const gsl::span<const std::byte>> fontFiles, FontSizeInfo sizeInfo, float radius, Vector<char32_t> characters);
