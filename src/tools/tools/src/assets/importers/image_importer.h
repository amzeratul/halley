...
namespace Halley
{
	...
	private:
		static std::unique_ptr<Image> convertToIndexed(const String& fileName, const Image& image, const Image& palette, const String& paletteName, const ConfigNode& assetOptions, bool readTopLineOnly);
