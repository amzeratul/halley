...
namespace Halley
{
	...
	public:
		...
		CodeGenResult generateSystem(SystemSchema system, const HashMap<String, ComponentSchema>& components, const HashMap<String, MessageSchema>& messages, const HashMap<String, SystemMessageSchema>& systemMessages) override;
	...
	private:
		...
		Vector<String> generateSystemHeader(SystemSchema& system, const HashMap<String, ComponentSchema>& components, const HashMap<String, MessageSchema>& messages, const HashMap<String, SystemMessageSchema>& systemMessages) const;
