...
namespace Halley
{
	...
	{
	public:
		static std::optional<Vector<BinPackResult>> pack(const Vector<BinPackEntry>& entries, Vector2i binSize);
		static std::optional<Vector<BinPackResult>> fastPack(const Vector<BinPackEntry>& entries, Vector2i binSize);
	};
}
