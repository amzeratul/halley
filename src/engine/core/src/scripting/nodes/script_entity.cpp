...
{
	auto entityId = readEntityId(environment, node, 2);
	...
	environment.getWorld().destroyEntity(entityId);
	return Result(ScriptNodeExecutionState::Done);
}
...
gsl::span<const IScriptNodeType::PinType> ScriptFindChildByName::getPinConfiguration(const BaseGraphNode& node) const
{
	using ET = ScriptNodeElementType;
	using PD = GraphNodePinDirection;
	const static auto data = std::to_array({ PinType{ ET::ReadDataPin, PD::Input }, PinType{ ET::TargetPin, PD::Input }, PinType{ ET::TargetPin, PD::Output } });
	return data;
}
...
gsl::span<const IScriptNodeType::PinType> ScriptGetParent::getPinConfiguration(const BaseGraphNode& node) const
{
	using ET = ScriptNodeElementType;
	using PD = GraphNodePinDirection;
	const static auto data = std::to_array({ PinType{ ET::TargetPin, PD::Input }, PinType{ ET::TargetPin, PD::Output } });
	return data;
}
...
gsl::span<const IScriptNodeType::PinType> ScriptEntityReference::getPinConfiguration(const BaseGraphNode& node) const
{
	using ET = ScriptNodeElementType;
	using PD = GraphNodePinDirection;
	const static auto data = std::to_array({ PinType{ ET::TargetPin, PD::Output }, PinType{ ET::ReadDataPin, PD::Output }, PinType{ ET::ReadDataPin, PD::Input }, PinType{ ET::TargetPin, PD::Input } });
	return data;
}
...
ConfigNode ScriptEntityParameter::doGetData(ScriptEnvironment& environment, const ScriptGraphNode& node, size_t pinN) const
{
	...
	if (auto* scriptableComponent = environment.tryGetComponent<ScriptableComponent>(readEntityId(environment, node, 1))) {
		const auto& params = scriptableComponent->entityParams;
