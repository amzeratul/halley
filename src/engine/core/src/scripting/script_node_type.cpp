...
void ScriptNodeTypeCollection::addBasicScriptNodes()
{
	...
	addScriptNode(std::make_unique<ScriptInputAxis>());
	...
	addScriptNode(std::make_unique<ScriptCacheValue>());
	...
	addScriptNode(std::make_unique<ScriptRandomElement>());
