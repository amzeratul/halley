...
namespace Halley {
	...
	public:
		...
		virtual bool atomicWriteFile(const Path& path, gsl::span<const gsl::byte> data, std::optional<Path> backupOldVersionPath = {});
		...
		virtual bool runCommandDetached(const String& string, const String& cwd = "");
