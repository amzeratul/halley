...
namespace Halley {
    ...
    public:
	    ...
	    void draw(const Material& material, size_t numVertices, gsl::span<const char> objectData, gsl::span<const char> vertexData, gsl::span<const IndexType> indices, PrimitiveType primitive, bool allIndicesAreQuads);
