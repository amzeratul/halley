...
namespace Halley {
	...
	public:
		UIScrollBarPane(String id, Vector2f clipSize, UIStyle style, UISizer&& sizer, bool scrollHorizontal = false, bool scrollVertical = true, bool alwaysShow = true, Vector2f minSize = {}, float scrollSpeed = 50.0f, bool smoothGoTo = false);
	...
	protected:
		void collectWidgetsForUpdating(Vector<std::shared_ptr<UIWidget>>& dst) override;
