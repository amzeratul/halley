...
namespace Halley {
	...
	public:
		...
		virtual bool setSelectedOptionIds(gsl::span<const String> ids, SelectionMode mode = SelectionMode::Normal);
		...
		std::optional<int> getOptionIndex(const String& id) const;
		...
		void setItemIcon(int idx, Sprite icon);
