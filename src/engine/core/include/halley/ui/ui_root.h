...
namespace Halley {
	...
	private:
		...
		WidgetUnderMouseResult getWidgetUnderMouse(const std::shared_ptr<UIWidget>& curWidget, Vector2f mousePos, bool includeDisabled = false, bool ignoreMouseInteraction = false, int childLayerAdjustment = 0, bool restricted = false) const;
