...
namespace Halley {
	...
	public:
		...
		std::optional<WorldPosition> getClosestPointTo(WorldPosition pos, float maxDist = std::numeric_limits<float>::infinity(), float anisotropy = 1.0f, float nudge = 0.1f) const;
