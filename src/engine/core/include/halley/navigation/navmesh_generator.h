...
namespace Halley {
	...
	public:
		struct Params {
			...
			gsl::span<const Vector2f> seeds; // These points mark their navmeshes as "connected"
			int subWorld = 0;
	...
	private:
		...
		static void checkForConnectivitySeeds(Navmesh& navmesh, gsl::span<const Vector2f> seeds);
	};
}
