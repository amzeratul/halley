...
if (MSVC)
	...
	if (${CMAKE_CXX_COMPILER_ID} STREQUAL MSVC)
		...
		if (HALLEY_HAS_LIVEPP)
			...
			set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} /LTCG /OPT:REF /DEBUG:FULL")
